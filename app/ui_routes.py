    ...
    try:
        ...
        if campaigns_response.status_code == 200:
            ...
            for campaign in campaigns[:5]:  # Limit to 5 recent campaigns
                summary_response = requests.get(f'{API_BASE}/reporting/campaigns/{campaign["id"]}/summary')
...
def campaign_summary(campaign_id):
    ...
    try:
        ...
        return render_template('campaign_summary.html', 
...
def trigger_campaign_proxy(campaign_id):
    ...
    try:
        response = requests.post(f'{API_BASE}/campaigns/{campaign_id}/trigger', 
                               json={})
